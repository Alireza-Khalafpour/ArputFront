...
const MyProductsFactory = () => {
  ...
  async function ListApi(Au) {
    await axios
      .get(`${url}/pre_product/factory/list`, {
        headers: {
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-paszamine3 py-4">
        {" "}
        <span className="text-xl font-bold"> لیست پیش محصول ها | </span> برای
        ایجاد محصول بر روی پیش محصول مورد نظر کلیک راست کنید یا دکمه{" "}
        <span className="text-khas font-bold"> " افزودن کالا " </span> را
        بفشارید.{" "}
      </p>
