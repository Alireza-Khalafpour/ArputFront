...
import { Alert, Dialog, DialogContent, DialogTitle, FormControl, IconButton, InputAdornment, OutlinedInput, Snackbar, TextField} from '@mui/material';
import { Apartment, LoopOutlined, MobileFriendly, Password, People, Person, Store, Visibility, VisibilityOff } from '@mui/icons-material';
...
export default function ForgotPassword() {
  ...
  return (
    ...
    <button onClick={() => setOpenForgotPasswordModal(true)} className='w-1/2 hover:text-[#443DC0] hover:font-semibold hover:cursor-pointer hover:border-b-[3px]' > فراموشی رمز </button>
    ...
    >
        ...
        <DialogContent>
                ...
                <div className='w-full min-w-[40vw] min-h-[40vh]' >
                ...
                <Grid className=' w-full' >
                    ...
                    <Grid className='w-full text-center' >
                        ...
                        activeStep===1 &&(
                            ...
                            type="button"
                            >
                                { loading ? <Password/> : <div>  <Password/>  بروزرسانی رمز </div> } 
                            </button>
                            </div>
