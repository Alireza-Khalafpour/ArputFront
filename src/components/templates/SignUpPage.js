    ...
    if (Otp.length === 4 && password === ConfirmPassword) {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data.Done === true) {
            setMessage(
              " ثبت نام با موفقیت انجام شد. لطفا برای تکمیل اطلاعات وارد پروفایل خود شوید "
            );
            setAlert(true);
            // setTimeout(() => {
            // }, 1700);
  ...
  return (
    <>
      <div className="w-[100vw]" >
        ...
        <div style={{ direction: "ltr" }} className="md:w-[37vw] w-full">
            ...
            <div className="w-full flex justify-center items-center flex-col shadow-sm">
              <div className="flex flex-col justify-center items-center">
                ...
                {activeStep === 1 && (
                  <>
                    <Grid
                      className=" w-full my-4 gap-2 justify-center items-center "
                    ...
                    >
                      ...
                      <Grid
                        className=" w-full text-center my-4 flex flex-col "
                        sx={{ display: "flex", flexDirection: "column" }}
                      >
                        <FormControl
                          margin="normal"
                ...
                {activeStep === 1 && (
                  <div className="w-full justify-center items-center flex flex-row gap-2">
                    <button
                      ...
                      className="text-white p-2 w-40 bg-khas transition-colors hover:bg-orange-600 duration-300 rounded-full"
                      type="button"
                    >
                      {loading ? (
                        <Person />
